...
WebUI.callTestCase(findTestCase('Blocks/Positive_tc/Page_checkout/LG006_checkout'), [('nameonCard') : nameonCard, ('cardNumber') : cardNumber
        , ('cvc') : cvc, ('expiryMonth') : expiryMonth, ('expiryYear') : expiryYear], FailureHandling.STOP_ON_FAILURE)
